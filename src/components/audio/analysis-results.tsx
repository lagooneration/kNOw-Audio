        ...
        <CardContent>
          <div className="space-y-6">
            <div className="space-y-2">
              <h3 className="text-lg font-medium text-white/90 dark:text-white/90">Content Detection</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex flex-col p-4 bg-secondary/70 dark:bg-slate-700/50 backdrop-blur-sm rounded-md border dark:border-slate-600/30">
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-medium text-white/90 dark:text-white/90">Frequency Distribution</h3>
            <div className="space-y-2">
              {analysis.dominantFrequencyRanges
                ...
                .map((range, index) => (
                  <div key={index} className="space-y-1">
                    ...
                    <div className="w-full bg-secondary/70 dark:bg-slate-700/50 rounded-full h-2.5">
                      <div 
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-medium text-white/90 dark:text-white/90">Summary</h3>
            <div className="p-4 bg-secondary/70 dark:bg-slate-700/50 backdrop-blur-sm rounded-md border dark:border-slate-600/30">
